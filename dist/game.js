...
`)
      ...
      return { bind() {
        ...
        this.bind();
        for (let g2 in m) {
          let y = m[g2], x = r.getUniformLocation(h, g2);
    ...
    function Nr(e, n, r, u) {
      ...
      for (let [g2, y] of m)
        h[y] = f(g2 % c * o, Math.floor(g2 / c) * d);
    ...
    function Yr(e) {
      ...
      if (e.tiled) {
        ...
        for (let g2 = 0; g2 < o; g2++)
          for (let y = 0; y < d; y++)
            pe(D(P({}, e), { pos: (e.pos || f(0)).add(f(r * g2, u * y)).sub(m), scale: c.scale(e.scale || f(1)), tex: e.tex, quad: n, width: r, height: u, origin: "topleft" }));
      } else
    ...
    function me(e) {
      ...
      let { charStyleMap: r, text: u } = $r(e.text + ""), c = u.split(""), s = n.qw * n.tex.width, o = n.qh * n.tex.height, d = e.size || o, h = f(d / o).scale(f(e.scale || 1)), m = h.x * s + ((Zn = e.letterSpacing) != null ? Zn : 0), g2 = h.y * o + ((er = e.lineSpacing) != null ? er : 0), y = 0, x = g2, W = 0, O = [], M = [], ee = null, te = 0;
      for (; te < c.length; ) {
        let oe = c[te];
        oe === `
` ? (x += g2, y = 0, ee = null, M.push(oe), O.push(M), M = []) : (e.width ? y + m > e.width : false) && (x += g2, y = 0, ee != null && (te -= M.length - ee, oe = c[te], M = M.slice(0, ee)), ee = null, O.push(M), M = []), oe !== `
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
      }
      O.push(M), e.width && (W = e.width);
      let Ae = [], Oe = f(e.pos || 0), _ = Ye(e.origin || Ne).scale(0.5), se = -_.x * m - (_.x + 0.5) * (W - m), Ie = -_.y * g2 - (_.y + 0.5) * (x - g2), ut = 0;
      return O.forEach((oe, Bi) => {
        let Ni = (W - oe.length * m) * (_.x + 0.5);
        oe.forEach((ct, ji) => {
          var tr;
          let Gt = n.map[ct], Yi = ji * m, $i = Bi * g2;
          if (Gt) {
    ...
    function En(e) {
      let n = /* @__PURE__ */ new Map(), r = {}, u = {}, c = { _id: lr(), hidden: false, paused: false, children: [], parent: null, add(s) {
        ...
        return this.children.filter((o) => s ? o.is(s) : true).sort((o, d) => {
          var g2, y, x, W, O, M;
          let h = (y = p.layers[(g2 = o.layer) != null ? g2 : p.defLayer]) != null ? y : 0, m = (W = p.layers[(x = d.layer) != null ? x : p.defLayer]) != null ? W : 0;
        ...
        if (this.solid && ((o = this.area) == null ? void 0 : o.shape) === "rect") {
          ...
          p.root.every((h) => {
            ...
            if (!this.exists() || h === this || !h.solid || ((Oe = h.area) == null ? void 0 : Oe.shape) !== "rect")
              return;
            let m = h.worldArea(), g2 = yt(m, d);
            if (ae(g2, f(0))) {
              let _ = Math.min(Math.abs(g2.p1.x), Math.abs(g2.p2.x), Math.abs(g2.p1.y), Math.abs(g2.p2.y)), se = (() => {
                switch (_) {
                  case Math.abs(g2.p1.x):
                    return f(_, 0);
                  case Math.abs(g2.p2.x):
                    return f(-_, 0);
                  case Math.abs(g2.p1.y):
                    return f(0, _);
                  case Math.abs(g2.p2.y):
                    return f(0, -_);
                }
              })();
              this.pos = this.pos.sub(se), d = this.worldArea(), g2 = yt(m, d);
            }
            let y = { p1: f(0), p2: f(u, c) }, x = 1, W = g2.p1, O = f(g2.p1.x, g2.p2.y), M = g2.p2, ee = f(g2.p2.x, g2.p1.y), te = 0, Ae = { right: { p1: W, p2: O }, top: { p1: O, p2: M }, left: { p1: M, p2: ee }, bottom: { p1: ee, p2: W } };
            for (let _ in Ae) {
              let se = Ae[_];
    ...
    function fi(e = {}) {
      ...
      return { id: "area", add() {
        ...
        var g2;
        if (c === this || ((g2 = c.area) == null ? void 0 : g2.shape) !== "rect")
          return null;
        ...
        var m, g2, y, x;
        let c = (m = this.area.width) != null ? m : this.width, s = (g2 = this.area.height) != null ? g2 : this.height;
        if (c == null || s == null)
    ...
    function Vt(e, n = {}) {
      ...
      function c(o, d, h, m) {
        let g2 = f(1, 1);
        return h && m ? (g2.x = h / (o.width * d.w), g2.y = m / (o.height * d.h)) : h ? (g2.x = h / (o.width * d.w), g2.y = g2.x) : m && (g2.y = m / (o.height * d.h), g2.x = g2.y), g2;
      }
      __name(c, "c");
      return a(c, "calcTexScale"), { id: "sprite", width: 0, height: 0, frame: n.frame || 0, quad: n.quad || new k(0, 0, 1, 1), animSpeed: (s = n.animSpeed) != null ? s : 1, load() {
        ...
        u && this.stop(), u = { name: o, timer: 0, loop: (g2 = (m = d.loop) != null ? m : h.loop) != null ? g2 : false, pingpong: (x = (y = d.pingpong) != null ? y : h.pingpong) != null ? x : false, speed: (O = (W = d.speed) != null ? W : h.speed) != null ? O : 10, onEnd: (M = d.onEnd) != null ? M : () => {
        ...
        if (!r) {
          ...
          if (g2)
            if (g2.isBottom()) {
              ...
              g2.isTop() && (n = 0, this.trigger("headbutt", g2.target));
      ...
      return a(o, "trigger"), { id: "state", state: e, enterState(d, ...h) {
        ...
        if (r) {
          if (!(r == null ? void 0 : r[m]))
            return;
          let g2 = typeof r[m] == "string" ? [r[m]] : r[m];
          if (!g2.includes(d))
            throw new Error(`Cannot transition state from "${m}" to "${d}". Available transitions: ${g2.map((y) => `"${y}"`).join(", ")}`);
        }
    ...
    function Pi(e, n) {
      ...
      let r = [], u = f(n.pos || f(0)), c = 0, s = { offset() {
        ...
        if (!m)
          return;
        let g2 = f(u.x + h.x * n.width, u.y + h.y * n.height);
        for (let x of m)
          if (x.id === "pos") {
            g2.x += x.pos.x, g2.y += x.pos.y;
            break;
          }
        m.push(it(g2)), m.push(qi(this, h));
        let y = p.root.add(m);
        return r.push(y), y;
      }, width() {
        return c * n.width;
      ...
      return e.forEach((o, d) => {
        let h = o.split("");
        c = Math.max(h.length, c), h.forEach((m, g2) => {
          s.spawn(m, f(g2, d));
        });
      }), s;
    }
  ...
  loop(4, () => {
    loop(4, () => {
      if (g) {
        ...
        b2.onUpdate(() => {
          b2.moveTo(b2.pos.x, b2.pos.y - BSPEED);
        });
      }
    });
    if (g) {
